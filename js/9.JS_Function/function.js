/*
    ...
    - 동일한 코드를 반복해서 작성할 필요 없이 미리 하나의 코드만 작성한 후 호출하여 사용하여 코드의 재사용성을 높일 수 있음
...
/*
    - 기명 함수 표현식
*/
let func1 = add;    //?  함수 할당 값을 더한다는 의미 / 밑의 func2 와 동일식
// func1 = add();              //? 함수의 결과를 집어넣겠다
...
const result = add2(getlnterger, 14.67, 16.33);
console.log(result);
