...
/*
    ...
    - 원본 배열 변경 X
    - forEach : 단순히 요소를 가지고 작업만 진행(반환 값 X)
        map : 요소를 가지고 작업만 결과로 배열을 새로 만듦(반환 값 O)
*/
...
/*
    filter(콜백 함수) : 콜백 함수의 반환 값이 true 인 배열의 요소의 값만을 추출한 새로운 배열을 생성
...
/*
    find(콜백 함수) : 콜백 함수 결과가 true 인 첫번째 요소를 반환 
*/
